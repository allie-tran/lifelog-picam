...
import cv2
from schemas import ObjectDetection
...
import logging
from core.config import _FACE_SIMILARITY_THRESHOLD
...
def extract_object_from_images(image_paths, whitelist: list[Person] | None = None, models_wrapper=default_models_wrapper):
